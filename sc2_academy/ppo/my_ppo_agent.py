...
# ------------------------------------------------------------------------------------------
# DISCLAIMER: This is just a slightly adjusted version of the PPO agent in TF-Agents.
#             Most of the code here is directly copied from there.
#             I had to remove the greedy policy since it did not work for my environment.
# ------------------------------------------------------------------------------------------
...
from ppo import my_epsilon_greedy_policy
...
class PPOAgent(tf_agent.TFAgent):
  ...
  def __init__(
    ...
    # My change is here:
    policy = my_epsilon_greedy_policy.EpsilonGreedyPolicy(
